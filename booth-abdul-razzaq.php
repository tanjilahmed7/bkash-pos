...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
            ...
            */
            ...
            if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                ...
                if (empty($name)) {
                    ...
                    echo '<meta http-equiv="refresh" content="2; URL=booth-abdul-razzaq.php">';
                    die();                
                }
                                            ...
                                            if (1930 <= $year) {
                                                try {
                                                    ...
                                                    foreach ($array_profession as $profession) {
                                                        $PDO = $auth_user->runQuery("INSERT INTO `profession_category` (`reg_table_id`, `profession`, `ticket_type`) VALUES ('$last_id', '$profession', 'BA');");
                                                        $PDO->execute();
                                                    }                                                    
        ...
        <div class="container" style="margin-top:80px;">
            ...
            <div class="main">
                <div class="col-md-10">
                    <h3 class="title">Abdul Razzaq Foundation</h3>
                    <form method="post">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-12">
                            ...
                            <input class="form-control" name="address" id="address" required autofocus> 
                        </div>                    
                        <div class="col-md-6">
