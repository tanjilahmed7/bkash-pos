    ...
    try {
      ...
      if($regrow)
      {
            ...
            */
            ...
            $d1 = '2016-11-24 12:00:00';
            $d2 = '2016-11-25 12:00:00';
            $d3 = '2016-11-26 12:00:00';
            $d4 = '2016-11-27 12:00:00';
            $d5 = '2016-11-28 12:00:00';
            $d6 = '2016-11-29 12:00:00';
            ...
            if ($CurrentDateTime>=$d1 && $CurrentDateTime<$d2) {
              ...
              try {
                  ...
                  $PDO = $auth_user->runQuery("INSERT INTO log_info (RegNumber, MemDT, RegGate, Status, RegEvent,day) values('$bar', '$currentdt','1', $status, 'AF2016','$MusicFestDay')");
                  $PDO->execute();
