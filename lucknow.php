        ...
        <?php
            ...
            */
             ...
             */
              ...
              $registration_number = $auth_user->RegID('BL');
            ...
            if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                ...
                if (empty($name)) {
                    ...
                    echo '<meta http-equiv="refresh" content="2; URL=lucknow.php">';
                    die();                
                }
                                            ...
                                            if (1930 <= $year) {
                                                try {
                                                    ...
                                                    foreach ($array_profession as $profession) {
                                                        $PDO = $auth_user->runQuery("INSERT INTO `profession_category` (`reg_table_id`, `profession`, `ticket_type`) VALUES ('$last_id', '$profession', 'BL');");
                                                        $PDO->execute();
                                                    }                                                    
