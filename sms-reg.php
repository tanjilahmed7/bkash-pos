...
// $getmobile  ="01844050607";
// $getmobile  ="01715448331";
// $getmobile  ="01844050548"; // Mahi bhaia
...
$getmobile     =   substr($getmobile,-11);
echo "Get mobile : " . $getmobile . "<br>";
die();



if ($getmobile=='01715448331' || $getmobile=='01844050548' || $currentdate >= $reg_open_date) {
                    ...
                    if (!empty($year) AND preg_match_all($special_char, $year) == FALSE) {
                        ...
                        if (2004 >= $year) {
                            if (1930 <= $year) {
                                ...
                                if ($mobilerow == "" || $mobile =="01715448331" || $mobile == "01844050548") // changed for test purpose
                                {
